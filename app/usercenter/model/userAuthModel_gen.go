...
var (
	...
	cacheMicroservicesUsercenterUserAuthIdPrefix              = "cache:microservicesUsercenter:userAuth:id:"
	cacheMicroservicesUsercenterUserAuthAuthTypeAuthKeyPrefix = "cache:microservicesUsercenter:userAuth:authType:authKey:"
	cacheMicroservicesUsercenterUserAuthUserIdAuthTypePrefix  = "cache:microservicesUsercenter:userAuth:userId:authType:"
)
...
func (m *defaultUserAuthModel) Insert(ctx context.Context, session sqlx.Session, data *UserAuth) (sql.Result, error) {
	...
	microservicesUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheMicroservicesUsercenterUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	microservicesUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cacheMicroservicesUsercenterUserAuthIdPrefix, data.Id)
	microservicesUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheMicroservicesUsercenterUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
	...
	}, microservicesUsercenterUserAuthAuthTypeAuthKeyKey, microservicesUsercenterUserAuthIdKey, microservicesUsercenterUserAuthUserIdAuthTypeKey)
}

func (m *defaultUserAuthModel) FindOne(ctx context.Context, id int64) (*UserAuth, error) {
	microservicesUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cacheMicroservicesUsercenterUserAuthIdPrefix, id)
	var resp UserAuth
	err := m.QueryRowCtx(ctx, &resp, microservicesUsercenterUserAuthIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserAuthModel) FindOneByAuthTypeAuthKey(ctx context.Context, authType string, authKey string) (*UserAuth, error) {
	microservicesUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cacheMicroservicesUsercenterUserAuthAuthTypeAuthKeyPrefix, authType, authKey)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, microservicesUsercenterUserAuthAuthTypeAuthKeyKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) FindOneByUserIdAuthType(ctx context.Context, userId int64, authType string) (*UserAuth, error) {
	microservicesUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cacheMicroservicesUsercenterUserAuthUserIdAuthTypePrefix, userId, authType)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, microservicesUsercenterUserAuthUserIdAuthTypeKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheMicroservicesUsercenterUserAuthIdPrefix, primary)
}
