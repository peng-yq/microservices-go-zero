...
type UpdateHomestayOrderTradeStateReq struct {
	...
	Sn         string `protobuf:"bytes,1,opt,name=sn,proto3" json:"sn,omitempty"`
	TradeState int64  `protobuf:"varint,2,opt,name=tradeState,proto3" json:"tradeState,omitempty"` // -1: Cancelled 0: Waiting for payment 1: Unused 2: Used 3: Passed the closing time
}
