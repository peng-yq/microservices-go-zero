...
var (
	...
	cacheMicroservicesOrderHomestayOrderIdPrefix = "cache:microservicesOrder:homestayOrder:id:"
	cacheMicroservicesOrderHomestayOrderSnPrefix = "cache:microservicesOrder:homestayOrder:sn:"
)
...
func (m *defaultHomestayOrderModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayOrder) (sql.Result, error) {
	...
	microservicesOrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheMicroservicesOrderHomestayOrderIdPrefix, data.Id)
	microservicesOrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheMicroservicesOrderHomestayOrderSnPrefix, data.Sn)
	...
	}, microservicesOrderHomestayOrderIdKey, microservicesOrderHomestayOrderSnKey)
}

func (m *defaultHomestayOrderModel) FindOne(ctx context.Context, id int64) (*HomestayOrder, error) {
	microservicesOrderHomestayOrderIdKey := fmt.Sprintf("%s%v", cacheMicroservicesOrderHomestayOrderIdPrefix, id)
	var resp HomestayOrder
	err := m.QueryRowCtx(ctx, &resp, microservicesOrderHomestayOrderIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayOrderModel) FindOneBySn(ctx context.Context, sn string) (*HomestayOrder, error) {
	microservicesOrderHomestayOrderSnKey := fmt.Sprintf("%s%v", cacheMicroservicesOrderHomestayOrderSnPrefix, sn)
	var resp HomestayOrder
	err := m.QueryRowIndexCtx(ctx, &resp, microservicesOrderHomestayOrderSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayOrderModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheMicroservicesOrderHomestayOrderIdPrefix, primary)
}
