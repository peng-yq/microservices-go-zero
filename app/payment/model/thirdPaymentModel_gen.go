...
var (
	...
	cacheMicroservicesPaymentThirdPaymentIdPrefix = "cache:microservicesPayment:thirdPayment:id:"
	cacheMicroservicesPaymentThirdPaymentSnPrefix = "cache:microservicesPayment:thirdPayment:sn:"
)
...
func (m *defaultThirdPaymentModel) Insert(ctx context.Context, session sqlx.Session, data *ThirdPayment) (sql.Result, error) {
	...
	microservicesPaymentThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheMicroservicesPaymentThirdPaymentIdPrefix, data.Id)
	microservicesPaymentThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheMicroservicesPaymentThirdPaymentSnPrefix, data.Sn)
	...
	}, microservicesPaymentThirdPaymentIdKey, microservicesPaymentThirdPaymentSnKey)
}

func (m *defaultThirdPaymentModel) FindOne(ctx context.Context, id int64) (*ThirdPayment, error) {
	microservicesPaymentThirdPaymentIdKey := fmt.Sprintf("%s%v", cacheMicroservicesPaymentThirdPaymentIdPrefix, id)
	var resp ThirdPayment
	err := m.QueryRowCtx(ctx, &resp, microservicesPaymentThirdPaymentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultThirdPaymentModel) FindOneBySn(ctx context.Context, sn string) (*ThirdPayment, error) {
	microservicesPaymentThirdPaymentSnKey := fmt.Sprintf("%s%v", cacheMicroservicesPaymentThirdPaymentSnPrefix, sn)
	var resp ThirdPayment
	err := m.QueryRowIndexCtx(ctx, &resp, microservicesPaymentThirdPaymentSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultThirdPaymentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheMicroservicesPaymentThirdPaymentIdPrefix, primary)
}
