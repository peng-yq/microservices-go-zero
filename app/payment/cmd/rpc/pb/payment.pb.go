...
type CreatePaymentReq struct {
	...
	PayTotal    int64  `protobuf:"varint,3,opt,name=payTotal,proto3" json:"payTotal,omitempty"` // fen
...
type CreatePaymentResp struct {
	...
	Sn string `protobuf:"bytes,1,opt,name=sn,proto3" json:"sn,omitempty"` // Transaction record number
}
...
type PaymentDetail struct {
	...
	UserId         int64  `protobuf:"varint,3,opt,name=userId,proto3" json:"userId,omitempty"`                // User ID
	PayMode        string `protobuf:"bytes,4,opt,name=payMode,proto3" json:"payMode,omitempty"`               // Payment method WECHAT_PAY: WeChat Pay
	TradeType      string `protobuf:"bytes,5,opt,name=tradeType,proto3" json:"tradeType,omitempty"`           // Third-party payment type Jsapi/App, etc.
	TradeState     int64  `protobuf:"varint,6,opt,name=tradeState,proto3" json:"tradeState,omitempty"`        // Transaction status 0: Unpaid 1: Payment successful -1: Payment failed
	PayTotal       int64  `protobuf:"varint,7,opt,name=payTotal,proto3" json:"payTotal,omitempty"`            // Total payment amount (in cents)
	TransactionId  string `protobuf:"bytes,8,opt,name=transactionId,proto3" json:"transactionId,omitempty"`   // Third-party payment transaction ID
	TradeStateDesc string `protobuf:"bytes,9,opt,name=tradeStateDesc,proto3" json:"tradeStateDesc,omitempty"` // Payment status description
	OrderSn        string `protobuf:"bytes,10,opt,name=orderSn,proto3" json:"orderSn,omitempty"`              // Business order number
	ServiceType    string `protobuf:"bytes,11,opt,name=serviceType,proto3" json:"serviceType,omitempty"`      // Business type
	CreateTime     int64  `protobuf:"varint,12,opt,name=createTime,proto3" json:"createTime,omitempty"`       // Creation time
	UpdateTime     int64  `protobuf:"varint,13,opt,name=updateTime,proto3" json:"updateTime,omitempty"`       // Update time
	PayStatus      int64  `protobuf:"varint,14,opt,name=payStatus,proto3" json:"payStatus,omitempty"`         // Platform internal transaction status 0: Unpaid 1: Payment successful 2: Refunded -1: Payment failed
	PayTime        int64  `protobuf:"varint,15,opt,name=payTime,proto3" json:"payTime,omitempty"`             // Payment successful time
}
...
var file_payment_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x64, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x42, 0x06, 0x5a, 0x04,
...
var file_payment_proto_depIdxs = []int32{
	...
	5, // 4: pb.payment.GetPaymentSuccessRefundByOrderSn:input_type -> pb.GetPaymentSuccessRefundByOrderSnReq
	...
	6, // 8: pb.payment.GetPaymentSuccessRefundByOrderSn:output_type -> pb.GetPaymentSuccessRefundByOrderSnResp
	8, // 9: pb.payment.UpdateTradeState:output_type -> pb.UpdateTradeStateResp
