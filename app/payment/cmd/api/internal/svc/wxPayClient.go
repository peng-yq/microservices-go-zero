...
func NewWxPayClientV3(c config.Config) (*core.Client, error) {
	...
	// init the client with the merchant's private key, etc., 
	// and make it have the ability to automatically obtain WeChat payment platform certificates at regular intervals
