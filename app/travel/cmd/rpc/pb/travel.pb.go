...
type Homestay struct {
	...
	PeopleNum           int64  `protobuf:"varint,6,opt,name=peopleNum,proto3" json:"peopleNum,omitempty"`                      // Number of people the homestay can accommodate
	HomestayBusinessId  int64  `protobuf:"varint,7,opt,name=homestayBusinessId,proto3" json:"homestayBusinessId,omitempty"`    // Store ID
	UserId              int64  `protobuf:"varint,8,opt,name=userId,proto3" json:"userId,omitempty"`                            // Host ID
	RowState            int64  `protobuf:"varint,9,opt,name=rowState,proto3" json:"rowState,omitempty"`                        // 0: Inactive, 1: Active
	RowType             int64  `protobuf:"varint,10,opt,name=rowType,proto3" json:"rowType,omitempty"`                         // Selling type 0: by room, 1: by person
	FoodInfo            string `protobuf:"bytes,11,opt,name=foodInfo,proto3" json:"foodInfo,omitempty"`                        // Meal standards
	FoodPrice           int64  `protobuf:"varint,12,opt,name=foodPrice,proto3" json:"foodPrice,omitempty"`                     // Meal price
	HomestayPrice       int64  `protobuf:"varint,13,opt,name=homestayPrice,proto3" json:"homestayPrice,omitempty"`             // Homestay price
	MarketHomestayPrice int64  `protobuf:"varint,14,opt,name=marketHomestayPrice,proto3" json:"marketHomestayPrice,omitempty"` // Market price of the homestay
}
