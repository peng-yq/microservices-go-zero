...
var (
	...
	cacheMicroservicesTravelHomestayBusinessIdPrefix     = "cache:microservicesTravel:homestayBusiness:id:"
	cacheMicroservicesTravelHomestayBusinessUserIdPrefix = "cache:microservicesTravel:homestayBusiness:userId:"
)
...
func (m *defaultHomestayBusinessModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayBusiness) (sql.Result, error) {
	...
	microservicesTravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheMicroservicesTravelHomestayBusinessIdPrefix, data.Id)
	microservicesTravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheMicroservicesTravelHomestayBusinessUserIdPrefix, data.UserId)
	...
	}, microservicesTravelHomestayBusinessIdKey, microservicesTravelHomestayBusinessUserIdKey)
}

func (m *defaultHomestayBusinessModel) FindOne(ctx context.Context, id int64) (*HomestayBusiness, error) {
	microservicesTravelHomestayBusinessIdKey := fmt.Sprintf("%s%v", cacheMicroservicesTravelHomestayBusinessIdPrefix, id)
	var resp HomestayBusiness
	err := m.QueryRowCtx(ctx, &resp, microservicesTravelHomestayBusinessIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayBusinessModel) FindOneByUserId(ctx context.Context, userId int64) (*HomestayBusiness, error) {
	microservicesTravelHomestayBusinessUserIdKey := fmt.Sprintf("%s%v", cacheMicroservicesTravelHomestayBusinessUserIdPrefix, userId)
	var resp HomestayBusiness
	err := m.QueryRowIndexCtx(ctx, &resp, microservicesTravelHomestayBusinessUserIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultHomestayBusinessModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheMicroservicesTravelHomestayBusinessIdPrefix, primary)
}
