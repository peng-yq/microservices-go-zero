...
var (
	...
	cacheMicroservicesTravelHomestayCommentIdPrefix = "cache:microservicesTravel:homestayComment:id:"
)
...
func (m *defaultHomestayCommentModel) Insert(ctx context.Context, session sqlx.Session, data *HomestayComment) (sql.Result, error) {
	...
	microservicesTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheMicroservicesTravelHomestayCommentIdPrefix, data.Id)
	...
	}, microservicesTravelHomestayCommentIdKey)
}

func (m *defaultHomestayCommentModel) FindOne(ctx context.Context, id int64) (*HomestayComment, error) {
	microservicesTravelHomestayCommentIdKey := fmt.Sprintf("%s%v", cacheMicroservicesTravelHomestayCommentIdPrefix, id)
	var resp HomestayComment
	err := m.QueryRowCtx(ctx, &resp, microservicesTravelHomestayCommentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultHomestayCommentModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cacheMicroservicesTravelHomestayCommentIdPrefix, primary)
}
