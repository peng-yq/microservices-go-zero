...
func (m *defaultThirdPaymentModel) FindOne(ctx context.Context, id int64) (*ThirdPayment, error) {
	...
	err := m.QueryRowCtx(ctx, &resp, microservicesPaymentThirdPaymentIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultThirdPaymentModel) FindOneBySn(ctx context.Context, sn string) (*ThirdPayment, error) {
	...
	var resp ThirdPayment
	err := m.QueryRowIndexCtx(ctx, &resp, microservicesPaymentThirdPaymentSnKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
